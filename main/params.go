...
func init() {
	...
	// IPC
	ipcChainIDs := fs.String("ipc-chain-ids", "", "Comma separated list of chain ids to connect to. Example: 11111111111111111111111111111111LpoYY,4R5p2RXDGLqaifZE4hHWH9owe34pfoBULn1DrQTWivjg8o4aH")
